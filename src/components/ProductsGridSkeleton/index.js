...
import { CardWrapper } from "components/ProductsGrid/ProductCard/ProductCard.styled";
import {
  SProductsGrid,
  ProductsWrapper,
  CentralizerWrapper,
} from "components/ProductsGrid/ProductsGrid.styled";
    ...
    <SProductsGrid>
      <ProductsWrapper>
        {[1, 2, 3, 4, 5, 6, 7].map((index) => (
          <CentralizerWrapper key={"skeleton" + index}>
            <CardWrapper>
